  ...
  <div class="searchTool">
    <div class="searchwhere">
      <el-input placeholder="请输入匹配内容" v-model="input" class="input-with-select" style="width:80%">
        <span>查询</span>
        <el-button slot="append"  class = "el_button_query" icon="el-icon-search" @click="searchquery"></el-button>
      </el-input>
      <el-button type="text" class = "el_button_clear" @click="clearQuery">清空</el-button>
    </div>
