...
export default {
  ...
  methods: {
    ...
    getJsonData() {
      var self = this
      Cesium.Resource.fetchJson('data/electricalTransportation/ventilationSystem.json').then(function (jsonData) {
        var arr = []
