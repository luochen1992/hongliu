...
export default {
  ...
  methods: {
    ...
    getJsonData() {
      var self = this
      Cesium.Resource.fetchJson('data/electricalTransportation/electricalSystem.json').then(function (jsonData) {
        var arr = []
