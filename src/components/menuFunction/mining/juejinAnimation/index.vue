...
export default {
  ...
  methods: {
    ...
    getJsonData() {
      var self = this
      Cesium.Resource.fetchJson('data/miningEngineer/excavatabledata.json').then(function (jsonData) {
        var arr = []
