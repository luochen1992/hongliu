<template>
  <div ref="xbsjmodelbox"
       class="xbsj-model-box"
       :class="{'xbsj-model-box-close':collapsed}"
       :style="windowstyle"
       @click="showclick">
    <i @mousedown="startResize($event)"
       ref="barbr"
       class="bar"
       :class="{'hidden':collapsed}"></i>
    <!-- 标题 -->
    <div class="xbsj-model-header">
      <div class="xbsj-model-header-left"
           :class="{'xbsj-model-header-left2':collapsed}"></div>
      <div class="xbsj-model-header-center"
           :class="{'xbsj-model-header-center2':collapsed}"
           ref="xbsjmodelheader"
           @mousedown="startMove($event)">
        {{title}}
        <span class="xbsj-model-close"
              @click.stop="cancel"></span>
      </div>
      <div class="xbsj-model-header-right"
           :class="{'xbsj-model-header-right2':collapsed}"></div>
    </div>
    <div class="xbsj-model-body">
      <div class="xbsj-model-content-left"></div>
      <!-- 内容 -->
      ...
      <div class="xbsj-model-content-right"></div>
      <!-- 底部按钮 -->
      <div class="xbsj-model-footer">
        <div class="xbsj-model-footer-left"
             :class="{'xbsj-model-footer-left2':collapsed}"></div>
        <div class="xbsj-model-footer-center"
             :class="{'xbsj-model-footer-center2':collapsed}">
          <div v-if="footervisible&&!collapsed">
            <button class="btn cancelBtn"
                    v-if="showCancelButton"
                    @click="cancel">{{compCancelText}}</button>
            <button class="btn confirmBtn"
                    @click="ok">{{compOkText}}</button>
          </div>
        </div>
        <div class="xbsj-model-footer-right"
             :class="{'xbsj-model-footer-right2':collapsed}"></div>
      </div>
    </div>
  </div>
</template>
...
.xbsj-model-box {
  ...
  box-shadow: 0 0 20px 0 rgba(0, 255, 255, 0.6);
}
.xbsj-model-body {
  display: flex;
  width: 100%;
  height: calc(100% - 46px);
  /* background: url(../../../images/model-content.png) no-repeat;
...
.xbsj-model-content {
  ...
  background: url(../../../images/model-content-center.png) repeat;
  background-size: 100% 100%;
  opacity: 0.8;
}
...
.xbsj-model-header {
  ...
  text-align: center;
  user-select: none;
  /* background: url(../../../images/model-header.png) no-repeat;
  background-size: 100% 100%; */
}
.xbsj-model-header-left {
  width: 32px;
  height: 42px;
  background: url(../../../images/model-header-left.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-header-center {
  width: calc(100% - 64px);
  height: 42px;
  line-height: 42px;
  background: url(../../../images/model-header-center.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-header-right {
  width: 32px;
  height: 42px;
  background: url(../../../images/model-header-right.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-close {
  cursor: pointer;
...
.xbsj-model-footer-left {
  width: 32px;
  height: 44px;
  background: url(../../../images/model-footer-left.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-footer-center {
  width: calc(100% - 64px);
  height: 44px;
  background: url(../../../images/model-footer-center.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-footer-right {
  width: 32px;
  height: 44px;
  background: url(../../../images/model-footer-right.png) no-repeat;
  background-size: 100% 100%;
}
.btn {
  min-width: 64px;
...
.xbsj-model-header-left2 {
  background: url(../../../images/model-header-left2.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-header-center2 {
  background: url(../../../images/model-header-center2.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-header-right2 {
  background: url(../../../images/model-header-right2.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-footer-left2 {
  background: url(../../../images/model-footer-left2.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-footer-center2 {
  background: url(../../../images/model-footer-center2.png) no-repeat;
  background-size: 100% 100%;
}
.xbsj-model-footer-right2 {
  background: url(../../../images/model-footer-right2.png) no-repeat;
  background-size: 100% 100%;
}
</style>
