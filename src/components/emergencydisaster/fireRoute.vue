...
export default {
  ...
  methods: {
    ...
    hide() {
      ...
      // if (window.cesiumvariate.drawControl_f) {
      //   window.cesiumvariate.drawControl_f.removeAll()
      //   window.cesiumvariate.drawControl_f = null
      // }
    },
    succCallback() {
      var _this = this
      ...
      // window.cesiumvariate.drawControl_f = new CTMap.DrawTool(window.viewer, {
      //   hasEdit: false,
      //   // dragIcon: dragIcon,
      //   onStopDrawing: function (entity) {
      //     _this.drawingflag = false
    ...
    fireshow() {
      ...
      window.e_route.fiteE = viewer.scene.primitives.add(
    ...
    peopleAnimation(keyPos, orientation) {
      ...
      // viewer.trackedEntity = window.e_route.modelEntity
