...
import NavagateTool from '../children/bottomRightBar/navagateTool.vue'
import YingyanTool from '../children/bottomRightBar/yingyanTool.vue'
export default {
  name: 'bottomrightBar',
  computed: {
    ...mapGetters(['getBRToolBar'])
  },
  components: { NavagateTool, YingyanTool },
  data() {
    return {
      data: [],
      showsee: false
