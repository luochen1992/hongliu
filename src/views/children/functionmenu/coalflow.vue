  ...
  methods: {
    ...
    hide() {
      if (window.cesiumvariate._coaldataSource) {
        for (let i = 0; i < window.cesiumvariate._coaldataSource.length; i++) {
          viewer.dataSources.remove(window.cesiumvariate._coaldataSource[i])
        }
    ...
    addCoalFlow(url) {
      var tt = this
      window.cesiumvariate._coaldataSource = []
    ...
    return material;\n\
      ...
      window.cesiumvariate._coaldataSource.push(new Cesium.CustomDataSource(Cesium.createGuid()))
      viewer.dataSources.add(window.cesiumvariate._coaldataSource[window.cesiumvariate._coaldataSource.length - 1])
      var custom_flowMesh = window.cesiumvariate._coaldataSource[window.cesiumvariate._coaldataSource.length - 1]._primitives.add(
